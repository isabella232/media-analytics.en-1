...
| Action | Action Timeline (Seconds) | Playhead Position (Seconds) | Client Request | Implementation Details |
| --- | :---: | :---: | --- | --- |
| App starts ping event timer | 0 | 0 | | Start your 10-second ping timer. The first ping event should then fire 10 seconds into the session.  |
...
| Action | Action Timeline (Seconds) | Playhead Position (Seconds) | Client Request | Implementation Details |
| --- | :---: | :---: | --- | --- |
| Track chapter start event | 23 | 1 | `/api/v1/sessions/{sid}/events`  | After the play event, track the start of the first chapter.  |
...
| Action | Action Timeline (Seconds) | Playhead Position (Seconds) | Client Request | Implementation Details |
| --- | :---: | :---: | --- | --- |
| Buffer start event occurred | 33 | 11 | `/api/v1/sessions/{sid}/events`  | Track the move to the "buffering" state.  |
...
| Action | Action Timeline (Seconds) | Playhead Position (Seconds) | Client Request | Implementation Details |
| --- | :---: | :---: | --- | --- |
| App tracks chapter end | 45 | 20 | `/api/v1/sessions/{sid}/events`  | The first chapter ends, right before the second ad break.  |
...
| Action | Action Timeline (Seconds) | Playhead Position (Seconds) | Client Request | Implementation Details |
| --- | :---: | :---: | --- | --- |
| User pressed Pause | 64 | 31 | `/api/v1/sessions/{sid}/events`  | The user action moves the play state to "paused".  |
...
| Action | Action Timeline (Seconds) | Playhead Position (Seconds) | Client Request | Implementation Details |
| --- | :---: | :---: | --- | --- |
| Chapter 2 ends | 87 | 44 | `/api/v1/sessions/{sid}/events`  | Track the end of the second and final chapter.  |
