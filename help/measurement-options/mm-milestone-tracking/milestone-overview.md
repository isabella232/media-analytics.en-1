...
| `Media.trackVars` | **Syntax:** <br/><br/> `s.Media.trackVars =` <br/><br/> `"events,prop2,eVar1,eVar2,eVar3";` <br/><br/>A comma-separated list of all variables that are set in your video tracking code.  |
