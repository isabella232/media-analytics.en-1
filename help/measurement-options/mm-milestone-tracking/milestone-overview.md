...
These variables are used to send ad information in conjunction with the openAd method. See [VAST Video Ad Tracking.](https://docs.adobe.com/content/help/en/media-analytics/using/media-overview.html)
