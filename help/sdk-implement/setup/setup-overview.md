...
>[!IMPORTANT]
>
>The following instructions apply to the 2.x Media SDKs. If you are implementing a 1.x version of the Media SDK, see the [1.x Media SDK Documentation](../download-sdks.md). For Primetime integrators, see [Primetime Media SDK Documentation](#primetime-docs).
