...
1. User clicks ** `Opt-in` ** or ** `Opt-out` **. ![](graphics/opt-out.png) 
   <a id="fig_7D5D396DD991438FB8C3BDE1F8105AA6"></a> ![](graphics/opt_in_nielsen.png) 
   <a id="fig_249D7A2E7ADC4651BB534EC57F454D69"></a> ![](graphics/opt_out_nielsen.png) 
