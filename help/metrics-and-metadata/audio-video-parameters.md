...
| **Show Type** | <ul> <li> **SDK Key:** `SHOW_TYPE` </li> <li> **API Key:** `media.showType` </li> <li> **Required:** No </li> <li> **Type:** string </li> <li> **Sent with:** Initiate, Close </li> <li> **Min. SDK Version:** 1.5.7 </li> <li> **Sample value:** <ul> <li>"0" = Full episode </li> <li>"1" = Preview/trailer </li> <li>"2" = Clip </li> <li>"3" = Other </li> </ul> </li> </ul> | <ul> <li> **Adobe Analytics:** `a.media.type` </li> <li> **Heartbeats:** `s:meta:a.media.type` </li> </ul> | <ul> <li> **Available:** Yes </li> <li> **Reserved Variable:** eVar </li> <li> **Expiration:** On HIT </li> <li> **Report Name:** Show Type </li> <li> **Context Data:** `a.media.type` </li> <li> **Data Feed:** `videoshowtype` </li> <li> **Audience Manager:** `c_contextdata.a.media.type` </li> </ul> |
...
| **Estimated Streams** | <ul> <li> **SDK Key:** Automatically set </li> <li> **API Key:** N/A </li> <li> **Type:** number </li> <li> **Sent with:** Close </li> <li> **Min. SDK Version:** Any </li> <li> **Sample value:** <ul> <li>1 - For a 19 minutes playback </li> <li>2 - For a 31 minutes playback </li> <li>3 - For a 78 minutes playback </li> </ul> </li> </ul> | <ul> <li> **Adobe Analytics:** N/A </li> <li> **Heartbeats:** N/A </li> </ul> | <ul> <li> **Available:** Use custom processing rule </li> <li> **Reserved Variable:** N/A </li> <li> **Report Name:** Custom </li> <li> **Context Data:** `a.media.estimatedStreams` </li> <li> **Data Feed:** `N/A` </li> <li> **Audience Manager:** `c_contextdata.a.media.estimatedStreams` </li> </ul> |
