...
uuid: 81ca7016-2adf-4e3e-8aed-afc5913bc19b
index: y
internal: n
snippet: y
translate: y
...
1. Select the report suite(s) where you are collecting video data and click  ** [!UICONTROL  Edit Settings] ** > ** [!UICONTROL  Video Management] ** > ** [!UICONTROL  Video Reporting] ** . <a id="fig_091C05FE4F064B8F81CC3A93C2AC04DF"></a> ![](graphics/video_reporting.png)
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> 
     ...
     </fig><img placement="break" align="center" href="graphics/video-mapping.png" id="image_952F10D91A124288B7732B5A1B8A24E5" width="300px" /></p> </td> 
  </tr> 
  <tr> 
