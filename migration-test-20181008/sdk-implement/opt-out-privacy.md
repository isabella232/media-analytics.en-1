...
uuid: 7cd942c9-833f-4fc3-b2f7-2c2b7bf0007d
index: y
internal: n
snippet: y
translate: y
...
* **OTT Apps (Chromecast, Roku) -** 
  ...
  The OTT SDKs provide General Data Protection Regulation (GDPR)-ready APIs that allow you to set `opt` status flags for data collection and transmission, and to retrieve locally stored identities.
